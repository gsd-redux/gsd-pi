...
assertTrue(
  calls.join(" > ") === "invalidate > health > derive:/tmp/gsd-test > sync-sidebar > set-active:M001 > reconcile > preflight > merge > stop:Merge error on milestone M001: Error: remote rejected push",
